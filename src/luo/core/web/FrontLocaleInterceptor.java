...
public class FrontLocaleInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request,
		...
		//System.out.println("FrontLocaleInterceptor:>>>preHandle");
	...
	public void postHandle(HttpServletRequest request,
		...
		//System.out.println("FrontLocaleInterceptor:>>postHandle");
		LocaleResolver localeResolver = RequestContextUtils.getLocaleResolver(request);
		if (localeResolver == null) {
			throw new IllegalStateException("No LocaleResolver found: not in a DispatcherServlet request?");
		}
		//System.out.println("FrontLocaleInterceptor:>>LOCALE="+localeResolver.resolveLocale(request).toString());
